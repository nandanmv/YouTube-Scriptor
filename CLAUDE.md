...
- `AI_MODEL`: Model identifier (e.g., `openai/gpt-4o`, `gemini/gemini-1.5-pro`, `anthropic/claude-3-5-sonnet-20240620`)
...
python3.10 main.py discovery "claude code, cursor ai"
...
- **LiteLLM Integration**: InsightAgent uses LiteLLM for multi-provider AI support (OpenAI, Gemini, Claude, etc.)
